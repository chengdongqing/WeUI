...
import top.chengdongqing.weui.core.ui.components.WeSteps
        ...
        Row(
            ...
            WeSteps(
                ...
                options = listOf(
                    {
                        Column {
                            Text(text = "步骤一", color = WeTheme.colorScheme.textPrimary)
                            Text(
                                text = "描述内容详情",
                    ...
                    },
                    {
                        Column(modifier = Modifier.height(120.dp)) {
                            Text(text = "步骤二", color = WeTheme.colorScheme.textPrimary)
                            Text(
                                text = "描述内容详情",
                                color = WeTheme.colorScheme.textSecondary,
                                fontSize = 14.sp
                    ...
                    {
                        Column {
                            Text(text = "步骤三", color = WeTheme.colorScheme.textPrimary)
                            Text(
                                text = "描述内容详情",
                                color = WeTheme.colorScheme.textSecondary,
                                fontSize = 14.sp
                    ...
                    {
                        Column {
                            Text(text = "步骤四", color = WeTheme.colorScheme.textPrimary)
                        }
                    }
                )
            )
