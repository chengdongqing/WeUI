...
val MenuGroups = listOf(
    MenuGroup(
        "基础组件", Res.drawable.ic_nav_layout,
        listOf(
    ...
    MenuGroup(
        "媒体组件", Res.drawable.ic_nav_search,
        listOf(
    ...
    MenuGroup(
        "操作反馈", Res.drawable.ic_nav_feedback,
        listOf(
    ...
    MenuGroup(
        "系统服务", Res.drawable.ic_nav_layout,
        listOf(
    ...
    MenuGroup(
        "网络服务", Res.drawable.ic_nav_search,
        listOf(
    ...
    MenuGroup(
        "图表组件", Res.drawable.ic_nav_layout,
        listOf(
    ...
    MenuGroup(
        "扩展示例", Res.drawable.ic_nav_search,
        listOf(
