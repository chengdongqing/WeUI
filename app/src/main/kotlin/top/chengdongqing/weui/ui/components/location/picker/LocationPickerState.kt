...
private class LocationPickerStateImpl(
    ...
    override val current: LatLng?
        get() = _current
    override val mapCenter: LocationItem?
        get() = _mapCenter
    override var selectedLocation: LocationItem?
    ...
    private var _current by mutableStateOf<LatLng?>(null)
    private var _mapCenter by mutableStateOf<LocationItem?>(null)
    private var _selectedLocation by mutableStateOf<LocationItem?>(null)
    private var _isSearchMode by mutableStateOf(false)
    private var _isLoading by mutableStateOf(true)
    private var _isWaiting by mutableStateOf(false)
