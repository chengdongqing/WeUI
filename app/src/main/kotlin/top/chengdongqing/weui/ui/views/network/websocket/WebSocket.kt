package top.chengdongqing.weui.ui.views.network.websocket
...
@Composable
fun WebSocketPage(socketViewModel: WebSocketViewModel = viewModel()) {
    WePage(title = "WebSocket", description = "双向通信") {
