...
@Stable
interface MultipleColumnPickerState {
    val visible: Boolean
...
@Composable
fun rememberMultiplePickerState(): MultipleColumnPickerState {
    val state = remember { MultipleColumnPickerStateImpl() }
...
private class MultipleColumnPickerStateImpl : MultipleColumnPickerState {
    override var visible by mutableStateOf(false)
    var props by mutableStateOf<MultipleColumnPickerProps?>(null)
        private set
    ...
    override fun show(
        ...
        props = MultipleColumnPickerProps(title, range, value, onColumnChange, onChange)
        visible = true
    }
...
private data class MultipleColumnPickerProps(
    val title: String?,
